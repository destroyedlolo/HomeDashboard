...
function updateTPiscine()
	TPiscine:clear()
	TPiscine:print( string.format('%4.1f', SelSharedVar.Get('SondePiscine/TempPiscine')) )
	TPiscine:refresh()
end
...
function updateTSonde()
	TSonde:clear()
	TSonde:print( string.format('%4.1f', SelSharedVar.Get('SondePiscine/TempInterne')) )
	TSonde:refresh()
end
...
function updateVPoul()
	VPiscine:clear()
	VPiscine:print( string.format('%2.2f', SelSharedVar.Get('SondePiscine/Vcc')/1000) )
	VPiscine:refresh()
end
